...
MODE="reconstruct"
for MEMORY_TASK_FREQ in 0 1; do
  # for N in 1 2; do
  for N in 1; do
    for LR in 1e-04; do
      RUN_NAME=original_rmt_${BASE_MODEL}_L${L}H${H}D${D}_mem${N_MEM_TOKENS}_lr${LR}-${MODE}_${MEMORY_TASK_FREQ}_no_context_pos_emb
      ...
      accelerate launch \
        ...
        --memory_key_size 4 \
        --memory_value_size 4 \
        --remove_position_ids_for_context_only \
