...
MODEL_CPT="/workspace-SR006.nfs2/bulatov/rmt/runs/test-time/N8-K2V2-V62_1M/original_rmt_llama_L4H4D128_mem8_lr1e-04-reconstruct_0.5_bs_64_lr_1e-04/run_1/checkpoint-200000/model.safetensors"


MODEL_CPT_NAME="N8-rec"
for DATA_PATH in "N16-K2V2-V62_1M" "N32-K2V2-V62_1M"; do
  ...
  TOKENIZER_PATH="./tokenizers/kv_alphabet_${V}/"
    ...
    for LR in 1e-04 3e-04 5e-05; do
      for N in 1 2; do
        RUN_NAME=original_rmt_${BASE_MODEL}_L${L}H${H}D${D}_mem${N_MEM_TOKENS}_lr${LR}-${MODE}_${MEMORY_TASK_FREQ}_from_${MODEL_CPT_NAME}
