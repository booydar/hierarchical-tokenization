...
for N_MEM_TOKENS in 8 32 4; do
  for LR in 3e-04; do
    for N in 1; do
      ...
      RUN_NAME=rmca-v1.1_${BASE_MODEL}_L${L}H${H}D${D}_mem${N_MEM_TOKENS}_lr${LR}-${N_SEGMENTS}x${PAIRS_PER_SEGMENT}
      ...
      accelerate launch \
        ...
        run_rmca_on_kv_retrieval-v1.py \
        --exp_path $EXP_PATH \
