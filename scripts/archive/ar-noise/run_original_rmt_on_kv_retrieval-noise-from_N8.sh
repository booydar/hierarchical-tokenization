...
CPT_PATH="/workspace-SR006.nfs2/bulatov/rmt/runs/test-time/N8-K2V2-V62_1M/original_rmt_llama_L4H4D128_mem8_lr3e-04_from_N4_bs_64_lr_3e-04/run_1/checkpoint-200000/model.safetensors"
...
for LR in 3e-04; do
  for N in 1 2 3; do
    for NOISE_LEVEL in 0.25 0.5 0.75; do
      ...
      RUN_NAME=${RUN_NAME}_bs_${TBS}_lr_${LR}_from_N8
