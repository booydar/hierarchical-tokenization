...
PAIRS_PER_SEGMENT=1
for DATA_PATH in "N2-K2V2-V62_1M" "N4-K2V2-V62_1M" "N8-K2V2-V62_1M" "N16-K2V2-V62_1M"; do
  # for N in 1 2; do
  for N in 1; do
    for LR in 1e-04; do
      RUN_NAME=original_rmt_${BASE_MODEL}_L${L}H${H}D${D}_mem${N_MEM_TOKENS}_lr${LR}-pps${PAIRS_PER_SEGMENT}
