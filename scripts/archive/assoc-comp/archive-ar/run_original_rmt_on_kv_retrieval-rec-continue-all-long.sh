...
V=62
for DATA_PATH in "N32-K2V2-V62_1M" "N64-K2V2-V62_1M"; do
  ...
  for MEMORY_KEY_SIZE in 4 8; do
    for MEMORY_VALUE_SIZE in 16 32 64; do
      for LR in 1e-04 3e-04; do

        for N in 1 2; do
          RUN_NAME=original_rmt_${BASE_MODEL}_L${L}H${H}D${D}_mem${N_MEM_TOKENS}_lr${LR}-${MODE}_${MEMORY_KEY_SIZE}-${MEMORY_VALUE_SIZE}_${MEMORY_TASK_FREQ}
